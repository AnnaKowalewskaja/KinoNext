...
class ProfileAPI extends React.Component {
    ...
    async componentDidMount() {
        ...
        const MOVIE_PROFILE = fetch('https://api.themoviedb.org/3/movie/575264?language=en-US', options)
        ...
        this.props.setMovieProfile(await MOVIE_PROFILE);
    ...
    render() {
        return (
            <Profile {...this.props} movieProfile={this.props.movieProfile} />
        )
    }
